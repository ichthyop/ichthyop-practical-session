...
![No migration](img/vert2.png){#fig-mig1 width=100px}

![Migration between -10 and -30 m](img/vert3.png){#fig-mig2 width=100px}

![Constant depth (-50 m)](img/vert4.png){#fig-mig3 width=100px}
...
In Ichthyop, unselect Advanced - Release - Drifters from text file. Select Advanced - Release -
From zones. Edit the default file (benguela_zones.xml); it contains the release zones
...
to the TP1 directory, install the XML package if necessary, then execute the function (Figure
5a). Go back to Ichthyop and visualise the trajectories of individuals for the first release date
(Figure 5b). Note that in the end there is no individual inside the destination area! Look again
...
Mean (and standard error of the mean) transport success from 3 release zones to a destination zone,
for 3 release dates. The zones are shown in (b) with the final distribution of individuals for the first release date.
...
function (Figure 6a). Go back to Ichthyop and visualise the trajectories of individuals for the
first release date (Figure 6b). Note that the final positions of individuals in the north are very
different in Figure 5b and Figure 6b. Why?
...
(a) Mean transport success from 3 release zones to 3 destination zones, for 3 release dates. The zones
are shown in (b) with the final distribution of individuals for the first release date.
