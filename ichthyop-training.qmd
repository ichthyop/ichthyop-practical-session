...
(a) Mean transport success from 3 release zones to 3 destination zones, for 3 release dates. The zones are shown in (b) with the final distribution of individuals for the first release date.
...
the sp package if necessary and then execute the function (Figure 7). Do the same for TP1
...
that the trajectories are perfectly back-simulated (compare Figure 8 with Figure 3) except for
